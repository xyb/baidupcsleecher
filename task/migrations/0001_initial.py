    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transfer_completed_at', models.DateTimeField(blank=True, editable=False, null=True)),
                ('file_listed_at', models.DateTimeField(blank=True, editable=False, null=True)),
                ('sample_downloaded_at', models.DateTimeField(blank=True, editable=False, null=True)),
                ('full_downloaded_at', models.DateTimeField(blank=True, editable=False, null=True)),
